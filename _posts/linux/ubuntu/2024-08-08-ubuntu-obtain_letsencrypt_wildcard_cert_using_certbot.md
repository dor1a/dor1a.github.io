...
![TXT(SPF)](/assets/img/post/linux/ubuntu/2024-08-08-ubuntu-obtain_letsencrypt_wildcard_cert_using_certbot/1.png)
_TXT(SPF)_

다 넣었으면 위에 나와있는 Admin Toolbox와 같이 입력하여서 확인해본다.  
<https://toolbox.googleapps.com/apps/dig/#TXT/_acme-challenge.norikae.kro.kr.>

![;ANSWER 값 확인](/assets/img/post/linux/ubuntu/2024-08-08-ubuntu-obtain_letsencrypt_wildcard_cert_using_certbot/2.png)
_;ANSWER 값 확인_
